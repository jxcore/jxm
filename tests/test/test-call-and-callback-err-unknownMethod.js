...
/*
 1. client sends request to the server with Call() with unknown methodName
...
client.on("connect", function (client) {
    connected = true;
    client.Call("unknownMethod", null, function(str, err) {
        var id = server.getConfig("clientErrorCodes").methodUnknown.id;
