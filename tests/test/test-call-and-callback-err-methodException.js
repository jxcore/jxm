...
/*
 ...
 2. server's method is designed to throw an exception.
 2. client checks if error code is right
 */
...
client.on("connect", function (client) {
    connected = true;
    client.Call("server_method", null, function(str, err) {
        var id = server.getConfig("clientErrorCodes").methodError.id;
