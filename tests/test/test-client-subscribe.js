...
/*
 1. client subscribes to the channel and waits for the callback
 */
...
var connected = false;
var finished = false;
var subscribed_on_server = false;
...
process.on('exit', function () {
    ...
    assert.ok(subscribed_on_server, "Server did not receive subscribe request.");
