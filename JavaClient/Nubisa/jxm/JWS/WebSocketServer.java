 ...
 */
abstract class WebSocketServer extends WebSocketAdapter implements Runnable {
    ...
    /**
     * @see WebSocket#sendFragmentedFrame(jxm._.JWS.FR.Framedata.Opcode, ByteBuffer, boolean)
     */
